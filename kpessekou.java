...
public class kpessekou {
	...
	public static void main(String[] args) {
		...
		List<String> allCities = Arrays.asList("Lomé", "Sokodé",
				"Kpalimé", "Atakpamé", "Bassar", "Tsévié", "Aného", "Mango", "Dapaong", "Tchamba", "Niamtougou",
				"Bafilo", "Notsè", "Sotouboua", "Badou", "Biankouri", "Tabligbo", "Kandè", "Amlamé", "Galangachi",
				"Kpagouda",
				"Kara", "Vogan");

		// shuffle the list to get a random order
		
		Collections.shuffle(allCities);// initializing a table to track which cities were used for matches
